...
import type { MultisigAccountRow } from '../../test/pageElements/AccountRow.js';
...
import { MultisigAccountsPage } from '../../test/pages/accountsPage.js';

// FIXME isSplit Table
// eslint-disable-next-line jest/no-disabled-tests
describe.skip('Accounts page', () => {
  let accountsPage: MultisigAccountsPage;
  ...
  beforeEach(() => {
    accountsPage = new MultisigAccountsPage();
  ...
  describe('badges', () => {
    let accountRows: MultisigAccountRow[];
    ...
    describe('when genesis hash is not set', () => {
      ...
      describe('when isDevelopment flag', () => {
        let aliceRow: MultisigAccountRow;
