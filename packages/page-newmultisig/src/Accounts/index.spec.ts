// Copyright 2017-2024 @polkadot/app-newmultisg authors & contributors
...
import type { NewMultisigAccountRow } from '../../test/pageElements/AccountRow.js';
...
import { NewMultisigAccountsPage } from '../../test/pages/accountsPage.js';

// FIXME isSplit Table
// eslint-disable-next-line jest/no-disabled-tests
describe.skip('Accounts page', () => {
  let accountsPage: NewMultisigAccountsPage;
  ...
  beforeEach(() => {
    accountsPage = new NewMultisigAccountsPage();
  ...
  describe('badges', () => {
    let accountRows: NewMultisigAccountRow[];
    ...
    describe('when genesis hash is not set', () => {
      ...
      describe('when isDevelopment flag', () => {
        let aliceRow: NewMultisigAccountRow;
      ...
      describe('when no isDevelopment flag', () => {
        let bobRow: NewMultisigAccountRow;
